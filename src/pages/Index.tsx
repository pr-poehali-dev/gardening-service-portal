...
export default function Index() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Подбор и высадка декоративных растений',
      price: 'от 1500 ₽',
      details: 'Консультация по выбору растений, подготовка почвы, профессиональная посадка с учетом особенностей участка и климата.'
    },
    {
      icon: 'TreeDeciduous',
    ...
    },
    {
      ...
      description: 'Создание уникального дизайна вашего сада',
      price: 'от 5000 ₽',
      details: 'Разработка индивидуального проекта, 3D визуализация, подбор растений и материалов, полное сопровождение реализации.'
    },
    {
      icon: 'Droplet',
      title: 'Системы полива',
      description: 'Установка автоматического полива',
      price: 'от 8000 ₽',
      details: 'Проектирование и монтаж систем автоматического полива, настройка таймеров, обслуживание оборудования.'
    },
    {
      icon: 'Leaf',
      title: 'Уход за садом',
